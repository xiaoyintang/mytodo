...
export function AppShell({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-full w-full max-w-[460px] flex-col overflow-hidden bg-white pb-14 sm:min-h-0 sm:rounded-[16px] sm:border sm:border-[var(--color-border)] sm:pb-0">
      {children}
    </div>
  );
}
