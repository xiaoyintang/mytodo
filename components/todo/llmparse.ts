...
**先看动作本身有没有天然终点**——做完那一下就结束了的，一律 null，不用再看别的：
   放、关、买、删、发、穿、写出、做完、扔、打开、拍、签、报名…
   例："睡前把手机放客厅充电" → 放完就完了 → null
   例："买个遮光窗帘" → null
   例："卸载手机里的短视频APP" → null

**只有持续性动作才需要边界**——能一直做下去、不给个头就停不了的：
   看、查、研究、了解、学、练、背、读、复习、准备、整理、熟悉、刷…
   这时候看句子里有没有下面**任意一种**边界，有一种就算有，判 null：
   · 数量：3篇 / 一个 / 10条 / 两页 / 5家
   · 范围：前3段 / 定价页 / 第二章 / 选择题
   · 时长：10分钟 / 半小时 / 2分钟
